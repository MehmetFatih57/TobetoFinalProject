...
class TestPersonalInformationsPage(BaseTest):
    ...
    def test_update_personal_informations_succesfully(self):
        ...
        personal_informations_page.enter_birthdate("05-10-1995")
        personal_informations_page.enter_national_identity("26765448956")
        personal_informations_page.enter_gender("Erkek")
        personal_informations_page.enter_military_status("Yaptı")
        personal_informations_page.enter_disability_status("Yok")
        personal_informations_page.enter_github_address("https://github.com/MehmetFatih57")
        personal_informations_page.enter_country("Türkiye")
        personal_informations_page.enter_city("İstanbul")
        personal_informations_page.enter_district("Maltepe")
